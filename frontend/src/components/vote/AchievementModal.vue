  ...
  <Teleport to="body">
    <Transition name="achievement">
      <div v-if="show" class="fixed inset-0 z-50 flex items-center justify-center pointer-events-none">
        <div class="bg-white dark:bg-zinc-900 rounded-3xl p-8 text-center shadow-2xl border-2 border-green-400 pointer-events-auto max-w-sm w-full mx-4">
...
<style scoped>
.achievement-enter-active { animation: pop 0.4s cubic-bezier(0.34, 1.56, 0.64, 1); }
.achievement-leave-active { animation: pop 0.2s ease-in reverse; }
@keyframes pop {
